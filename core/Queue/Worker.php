...
use AwesomeCoder\Contracts\Queue\Factory as QueueManager;
use AwesomeCoder\Database\DetectsLostConnections;
use AwesomeCoder\Queue\Events\JobExceptionOccurred;
...
use AwesomeCoder\Queue\Events\Looping;
use AwesomeCoder\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @var \AwesomeCoder\Contracts\Debug\ExceptionHandler
     */
     ...
     * @param  \AwesomeCoder\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \AwesomeCoder\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Queue\Job|null  $job
     * @param  \AwesomeCoder\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     ...
     *
     * @param  int  $status
     * @param  \AwesomeCoder\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Queue\Job  $job
     * @return \AwesomeCoder\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \AwesomeCoder\Contracts\Queue\Factory
     */
