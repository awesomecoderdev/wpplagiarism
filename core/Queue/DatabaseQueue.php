...
use AwesomeCoder\Contracts\Queue\Queue as QueueContract;
use AwesomeCoder\Database\Connection;
use AwesomeCoder\Queue\Jobs\DatabaseJob;
use AwesomeCoder\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \AwesomeCoder\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \AwesomeCoder\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \AwesomeCoder\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \AwesomeCoder\Queue\Jobs\DatabaseJobRecord  $job
     * @return \AwesomeCoder\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \AwesomeCoder\Queue\Jobs\DatabaseJobRecord  $job
     * @return \AwesomeCoder\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \AwesomeCoder\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
