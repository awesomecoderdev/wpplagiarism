...
namespace AwesomeCoder\Queue\Failed;
...
class DynamoDbFailedJobProvider implements FailedJobProviderInterface
{
     ...
     * @param  string  $pluginlicationName
     * @param  string  $table
     * @return void
     */
    public function __construct(DynamoDbClient $dynamo, $pluginlicationName, $table)
    {
        $this->table = $table;
        $this->dynamo = $dynamo;
        $this->applicationName = $pluginlicationName;
    }
