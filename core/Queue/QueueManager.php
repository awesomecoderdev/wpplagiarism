...
use Closure;
use AwesomeCoder\Contracts\Queue\Factory as FactoryContract;
use AwesomeCoder\Contracts\Queue\Monitor as MonitorContract;
use InvalidArgumentException;

/**
 * @mixin \AwesomeCoder\Contracts\Queue\Queue
 */
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \AwesomeCoder\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
    ...
    public function setApplication($plugin)
    {
        ...
        foreach ($this->connections as $connection) {
            $connection->setContainer($plugin);
        }
