...
use Exception;
use AwesomeCoder\Bus\Batchable;
use AwesomeCoder\Bus\UniqueLock;
...
use AwesomeCoder\Contracts\Queue\ShouldBeUnique;
use AwesomeCoder\Contracts\Queue\ShouldBeUniqueUntilProcessing;
use AwesomeCoder\Database\Eloquent\ModelNotFoundException;
use AwesomeCoder\Pipeline\Pipeline;
use ReflectionClass;
...
class CallQueuedHandler
{
     ...
     *
     * @var \AwesomeCoder\Contracts\Bus\Dispatcher
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Bus\Dispatcher  $dispatcher
