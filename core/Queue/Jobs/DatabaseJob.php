...
class DatabaseJob extends Job implements JobContract
{
     ...
     *
     * @var \AwesomeCoder\Queue\DatabaseQueue
     */
    protected $database;
     ...
     * @param  \AwesomeCoder\Queue\DatabaseQueue  $database
     * @param  \stdClass  $job
