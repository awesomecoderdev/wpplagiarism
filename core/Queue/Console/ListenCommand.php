...
use AwesomeCoder\Queue\Listener;
use AwesomeCoder\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @var \AwesomeCoder\Queue\Listener
     */
    protected $listener;
     ...
     *
     * @param  \AwesomeCoder\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->plugin['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->plugin['config']->get(
     ...
     *
     * @return \AwesomeCoder\Queue\ListenerOptions
     */
