...
use AwesomeCoder\Contracts\Queue\ShouldBeEncrypted;
use AwesomeCoder\Queue\Events\JobQueued;
...
abstract class Queue
{
     ...
     * @return string
     *
     * @throws \AwesomeCoder\Queue\InvalidPayloadException
     */
    ...
    protected function createObjectPayload($job, $queue)
    {
        $payload = $this->withCreatePayloadHooks($queue, [
            ...
            'job' => 'AwesomeCoder\Queue\CallQueuedHandler@call',
     ...
     *
     * @return \AwesomeCoder\Container\Container
     */
