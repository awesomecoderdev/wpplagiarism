...
namespace AwesomeCoder\Database\Query;

use BackedEnum;
use Carbon\CarbonPeriod;
use Closure;
use DateTimeInterface;
use AwesomeCoder\Contracts\Database\Query\Builder as BuilderContract;
use AwesomeCoder\Contracts\Support\Arrayable;
use AwesomeCoder\Database\Concerns\BuildsQueries;
use AwesomeCoder\Database\Concerns\ExplainsQueries;
use AwesomeCoder\Database\ConnectionInterface;
use AwesomeCoder\Database\Eloquent\Builder as EloquentBuilder;
use AwesomeCoder\Database\Eloquent\Relations\Relation;
use AwesomeCoder\Database\Query\Grammars\Grammar;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \AwesomeCoder\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \AwesomeCoder\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \AwesomeCoder\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \AwesomeCoder\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \AwesomeCoder\Database\Query\JoinClause
     */
     ...
     *
     * @param  string  $column
     * @param  \AwesomeCoder\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Eloquent\Builder|\AwesomeCoder\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\AwesomeCoder\Database\Query\Builder|\AwesomeCoder\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
