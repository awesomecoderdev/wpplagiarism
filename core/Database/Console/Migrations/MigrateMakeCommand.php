...
use AwesomeCoder\Contracts\Console\PromptsForMissingInput;
...
class MigrateMakeCommand extends BaseCommand implements PromptsForMissingInput
{
     ...
     *
     * @var \AwesomeCoder\Database\Migrations\MigrationCreator
     */
    protected $creator;
     ...
     *
     * @param  \AwesomeCoder\Database\Migrations\MigrationCreator  $creator
    ...
    protected function getMigrationPath()
    {
        if (!is_null($targetPath = $this->input->getOption('path'))) {
            return !$this->usingRealPath()
                ? $this->plugin->basePath() . '/' . $targetPath
                : $targetPath;
        }
