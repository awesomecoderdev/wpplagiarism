...
use AwesomeCoder\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \AwesomeCoder\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \AwesomeCoder\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \AwesomeCoder\Support\Fluent
     */
     ...
     * @return \AwesomeCoder\Database\Schema\IndexDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \AwesomeCoder\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \AwesomeCoder\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \AwesomeCoder\Database\Schema\ColumnDefinition  $definition
     * @return \AwesomeCoder\Database\Schema\ColumnDefinition
     */
