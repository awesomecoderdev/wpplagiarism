...
use AwesomeCoder\Contracts\Validation\DataAwareRule;
use AwesomeCoder\Contracts\Validation\ImplicitRule;
use AwesomeCoder\Contracts\Validation\InvokableRule;
use AwesomeCoder\Contracts\Validation\Rule;
use AwesomeCoder\Contracts\Validation\ValidatorAwareRule;
use AwesomeCoder\Translation\PotentiallyTranslatedString;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \AwesomeCoder\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @var \AwesomeCoder\Validation\Validator
     */
    protected $validator;
     ...
     *
     * @param  \AwesomeCoder\Contracts\Validation\InvokableRule  $invokable
     * @return void
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Validation\InvokableRule  $invokable
     * @return \AwesomeCoder\Contracts\Validation\Rule
     */
     ...
     *
     * @return \AwesomeCoder\Contracts\Validation\InvokableRule
     */
     ...
     * @return \AwesomeCoder\Translation\PotentiallyTranslatedString
     */
