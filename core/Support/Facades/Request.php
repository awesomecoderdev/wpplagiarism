...
/**
 * @method static \AwesomeCoder\Http\Request capture()
 * @method static \AwesomeCoder\Http\Request instance()
 ...
 * @method static \AwesomeCoder\Http\Request merge(array $input)
 * @method static \AwesomeCoder\Http\Request mergeIfMissing(array $input)
 * @method static \AwesomeCoder\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\ParameterBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \AwesomeCoder\Http\Request createFrom(\AwesomeCoder\Http\Request $from, \AwesomeCoder\Http\Request|null $to = null)
 * @method static \AwesomeCoder\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \AwesomeCoder\Http\Request duplicate(array $query = null, array $request = null, array $attributes = null, array $cookies = null, array $files = null, array $server = null)
 ...
 * @method static \AwesomeCoder\Contracts\Session\Session session()
 * @method static void setLaravelSession(\AwesomeCoder\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \AwesomeCoder\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \AwesomeCoder\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \Closure getUserResolver()
 * @method static \AwesomeCoder\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \AwesomeCoder\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static string|array|null old(string|null $key = null, \AwesomeCoder\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \AwesomeCoder\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \AwesomeCoder\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \AwesomeCoder\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static array keys()
 * @method static array all(array|mixed|null $keys = null)
 * @method static mixed input(string|null $key = null, mixed $default = null)
 * @method static \AwesomeCoder\Support\Stringable str(string $key, mixed $default = null)
 * @method static \AwesomeCoder\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \AwesomeCoder\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \AwesomeCoder\Support\Collection collect(array|string|null $key = null)
 ...
 * @method static \AwesomeCoder\Http\UploadedFile|\AwesomeCoder\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static never dd(mixed ...$keys)
 * @method static \AwesomeCoder\Http\Request dump(mixed $keys = [])
