 ...
 * @method static \AwesomeCoder\Auth\AuthManager setApplication(\AwesomeCoder\Contracts\Foundation\Application $plugin)
...
class Auth extends Facade
{
    ...
    {
        if (!static::$plugin->providerIsLoaded(UiServiceProvider::class)) {
            throw new RuntimeException('In order to use the Auth::routes() method, please install the laravel/ui package.');
        }

        static::$plugin->make('router')->auth($options);
    }
}
