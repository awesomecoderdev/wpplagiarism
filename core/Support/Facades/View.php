...
/**
 * @method static \AwesomeCoder\Contracts\View\View file(string $path, \AwesomeCoder\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \AwesomeCoder\Contracts\View\View make(string $view, \AwesomeCoder\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \AwesomeCoder\Contracts\View\View first(array $views, \AwesomeCoder\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \AwesomeCoder\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \AwesomeCoder\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \AwesomeCoder\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \AwesomeCoder\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \AwesomeCoder\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \AwesomeCoder\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \AwesomeCoder\View\Engines\EngineResolver getEngineResolver()
 * @method static \AwesomeCoder\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\AwesomeCoder\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\AwesomeCoder\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\AwesomeCoder\Contracts\View\View|\AwesomeCoder\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\AwesomeCoder\Contracts\View\View $view)
 * @method static void callCreator(\AwesomeCoder\Contracts\View\View $view)
