...
use AwesomeCoder\Auth\Events\Attempting;
use AwesomeCoder\Auth\Events\Authenticated;
use AwesomeCoder\Auth\Events\CurrentDeviceLogout;
use AwesomeCoder\Auth\Events\Failed;
use AwesomeCoder\Auth\Events\Login;
use AwesomeCoder\Auth\Events\Logout;
use AwesomeCoder\Auth\Events\OtherDeviceLogout;
use AwesomeCoder\Auth\Events\Validated;
use AwesomeCoder\Contracts\Auth\Authenticatable as AuthenticatableContract;
use AwesomeCoder\Contracts\Auth\StatefulGuard;
use AwesomeCoder\Contracts\Auth\SupportsBasicAuth;
...
use AwesomeCoder\Support\Facades\Hash;
use AwesomeCoder\Support\Str;
use AwesomeCoder\Support\Timebox;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \AwesomeCoder\Contracts\Session\Session
     */
    protected $session;
     ...
     *
     * @var \AwesomeCoder\Support\Timebox
     */
    protected $timebox;
     ...
     *
     * @param  string  $name
     * @param  \AwesomeCoder\Contracts\Auth\UserProvider  $provider
     * @param  \AwesomeCoder\Contracts\Session\Session  $session
     * @param  \Symfony\Component\HttpFoundation\Request|null  $request
     * @param  \AwesomeCoder\Support\Timebox|null  $timebox
     * @return void
     */
     ...
     *
     * @param  \AwesomeCoder\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \AwesomeCoder\Auth\Recaller|null
     */
     ...
     *
     * @param  mixed  $id
     * @return \AwesomeCoder\Contracts\Auth\Authenticatable|false
     */
     ...
     *
     * @param  \AwesomeCoder\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
     */
     ...
     *
     * @return \AwesomeCoder\Contracts\Auth\Authenticatable
     */
     ...
     *
     * @return \AwesomeCoder\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @return \AwesomeCoder\Support\Timebox
     */
