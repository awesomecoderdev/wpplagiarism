...
use Closure;
use AwesomeCoder\Contracts\Auth\Factory as FactoryContract;
use InvalidArgumentException;

/**
 * @mixin \AwesomeCoder\Contracts\Auth\Guard
 * @mixin \AwesomeCoder\Contracts\Auth\StatefulGuard
 */
class AuthManager implements FactoryContract
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \AwesomeCoder\Auth\SessionGuard
     */
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \AwesomeCoder\Auth\TokenGuard
     */
