...
class Event
{
     ...
     *
     * @param  \Illuminate\Contracts\Foundation\Application  $plugin
     * @return bool
     */
    public function isDue($plugin)
    {
        if (!$this->runsInMaintenanceMode() && $plugin->isDownForMaintenance()) {
            return false;
        }

        return $this->expressionPasses() &&
            $this->runsInEnvironment($plugin->environment());
    }
     ...
     * @return bool
     */
    public function filtersPass($plugin)
    {
        foreach ($this->filters as $callback) {
            if (!$plugin->call($callback)) {
                return false;
            }
        }
     ...
     * @param  bool  $pluginend
     * @return $this
     */
    public function sendOutputTo($location, $pluginend = false)
    {
        $this->output = $location;

        $this->shouldAppendOutput = $pluginend;
