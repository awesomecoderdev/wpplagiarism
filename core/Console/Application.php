...
class Pluginlication extends SymfonyApplication implements ApplicationContract
{
    /**
     * The Wordpress plugin instance.
     *
     ...
     *
     * @param  \Illuminate\Contracts\Container\Container  $plugin
     * @param  \Illuminate\Contracts\Events\Dispatcher  $events
     * @param  string  $version
     * @return void
     */
    public function __construct(Container $plugin, Dispatcher $events, $version)
    {
        parent::__construct('Wordpress Plugin Framework', $version);
    ...
    protected function parseCommand($command, $parameters)
    {
        if (is_subclass_of($command, SymfonyCommand::class)) {
            ...
            $command = $this->plugin->make($command)->getName();
        }
    ...
    public function resolve($command)
    {
        ...
        return $this->add($this->plugin->make($command));
    }
    ...
    {
        $this->setCommandLoader(new ContainerCommandLoader($this->plugin, $this->commandMap));
