...
namespace AwesomeCoder\Encryption;
...
class EncryptionServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton('encrypter', function ($plugin) {
            $config = $plugin->make('config')->get('app');
     ...
     * @return string
     *
     * @throws \AwesomeCoder\Encryption\MissingAppKeyException
     */
