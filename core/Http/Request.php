...
use AwesomeCoder\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new request instance from the given Wordpress Plugin request.
     *
     * @param  \AwesomeCoder\Http\Request  $from
     * @param  \AwesomeCoder\Http\Request|null  $to
     * @return static
     */
     ...
     * @param  mixed  $default
     * @return \AwesomeCoder\Routing\Route|object|string|null
     */
