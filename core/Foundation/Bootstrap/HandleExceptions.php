...
use AwesomeCoder\Log\LogManager;
...
class HandleExceptions
{
    ...
    public function handleDeprecationError($message, $file, $line, $level = E_DEPRECATED)
    {
        ...
        try {
            $logger = static::$plugin->make(LogManager::class);
        } catch (Exception $e) {
            return;
        }
        ...
        $options = static::$plugin['config']->get('logging.deprecations') ?? [];
    ...
    protected function shouldIgnoreDeprecationErrors()
    {
        return !class_exists(LogManager::class)
            || !static::$plugin->hasBeenBootstrapped()
            || static::$plugin->runningUnitTests();
    }
    ...
    {
        with(static::$plugin['config'], function ($config) {
    ...
    public function handleException(Throwable $e)
    {
        ...
        if (static::$plugin->runningInConsole()) {
    ...
    {
        $this->getExceptionHandler()->render(static::$plugin['request'], $e)->send();
    }
    ...
    {
        return fn (...$arguments) => static::$plugin
     ...
     *
     * @return \AwesomeCoder\Contracts\Debug\ExceptionHandler
     */
    protected function getExceptionHandler()
    {
        return static::$plugin->make(ExceptionHandler::class);
    }
     ...
     * @return void
     */
    public static function forgetplugin()
    {
        static::$plugin = null;
    }
}
