...
use AwesomeCoder\Cookie\Middleware\EncryptCookies;
...
class VerifyCsrfToken
{
     ...
     * @return void
     */
    public function __construct(Application $plugin, Encrypter $encrypter)
    {
        $this->plugin = $plugin;
     ...
     * @return mixed
     *
     * @throws \AwesomeCoder\Session\TokenMismatchException
     */
