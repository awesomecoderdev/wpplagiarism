...
namespace AwesomeCoder\Foundation\Http;

use Carbon\CarbonInterval;
use DateTimeInterface;
use AwesomeCoder\Contracts\Debug\ExceptionHandler;
use AwesomeCoder\Contracts\Foundation\Application;
use AwesomeCoder\Contracts\Http\Kernel as KernelContract;
use AwesomeCoder\Foundation\Http\Events\RequestHandled;
use AwesomeCoder\Routing\Pipeline;
...
class Kernel implements KernelContract
{
     ...
     * The router instance.
     *
     * @var \AwesomeCoder\Routing\Router
     */
    protected $router;
    ...
    protected $bootstrappers = [
        \AwesomeCoder\Foundation\Bootstrap\LoadEnvironmentVariables::class,
        \AwesomeCoder\Foundation\Bootstrap\LoadConfiguration::class,
        \AwesomeCoder\Foundation\Bootstrap\HandleExceptions::class,
        \AwesomeCoder\Foundation\Bootstrap\RegisterFacades::class,
        \AwesomeCoder\Foundation\Bootstrap\RegisterProviders::class,
        \AwesomeCoder\Foundation\Bootstrap\BootProviders::class,
    ];
     ...
     *
     * @var \AwesomeCoder\Support\Carbon|null
     */
    ...
    protected $middlewarePriority = [
        \AwesomeCoder\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
        \AwesomeCoder\Cookie\Middleware\EncryptCookies::class,
        \AwesomeCoder\Session\Middleware\StartSession::class,
        \AwesomeCoder\View\Middleware\ShareErrorsFromSession::class,
        \AwesomeCoder\Contracts\Auth\Middleware\AuthenticatesRequests::class,
        \AwesomeCoder\Routing\Middleware\ThrottleRequests::class,
        \AwesomeCoder\Routing\Middleware\ThrottleRequestsWithRedis::class,
        \AwesomeCoder\Contracts\Session\Middleware\AuthenticatesSessions::class,
        \AwesomeCoder\Routing\Middleware\SubstituteBindings::class,
        \AwesomeCoder\Auth\Middleware\Authorize::class,
    ];
     ...
     * @param  \AwesomeCoder\Routing\Router  $router
     * @return void
     */
     ...
     *
     * @return \AwesomeCoder\Support\Carbon|null
     */
    ...
    /**
     * Set the Wordpress plugin instance.
     *
     * @param  \AwesomeCoder\Contracts\Foundation\Application  $plugin
     * @return $this
     */
    public function setApplication(Application $plugin)
    {
        $this->plugin = $plugin;
