...
use AwesomeCoder\Foundation\Testing\Wormhole;
...
trait InteractsWithTime
{
     ...
     *
     * @param  int  $value
     * @return \AwesomeCoder\Foundation\Testing\Wormhole
     */
     ...
     *
     * @param  \DateTimeInterface|\Closure|\AwesomeCoder\Support\Carbon|string|bool|null  $date
     * @param  callable|null  $callback
     * @return mixed
     */
