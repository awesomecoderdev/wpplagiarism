...
use AwesomeCoder\Testing\Assert;
...
trait InteractsWithExceptionHandling
{
     ...
     *
     * @var \AwesomeCoder\Contracts\Debug\ExceptionHandler|null
     */
    ...
    protected function withoutExceptionHandling(array $except = [])
    {
        if ($this->originalExceptionHandler == null) {
            $this->originalExceptionHandler = plugin(ExceptionHandler::class);
        }
        ...
        $this->app->instance(ExceptionHandler::class, new class($this->originalExceptionHandler, $except) implements ExceptionHandler
        {
             ...
             *
             * @param  \AwesomeCoder\Contracts\Debug\ExceptionHandler  $originalHandler
             * @param  array  $except
             * @return void
             */
