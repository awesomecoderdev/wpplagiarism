...
trait InteractsWithContainer
{
     ...
     *
     * @var \AwesomeCoder\Foundation\Vite|null
     */
    protected $originalVite;

    /**
     * The original Wordpress Plugin Mix handler.
     *
     * @var \AwesomeCoder\Foundation\Mix|null
     */
    ...
    protected function withoutVite()
    {
        if ($this->originalVite == null) {
            $this->originalVite = plugin(Vite::class);
        }
    ...
    /**
     * Register an empty handler for Wordpress Plugin Mix in the container.
     *
     * @return $this
     */
    protected function withoutMix()
    {
        if ($this->originalMix == null) {
            $this->originalMix = plugin(Mix::class);
        }
    ...
    /**
     * Restore Wordpress Plugin Mix in the container.
     *
     * @return $this
     */
