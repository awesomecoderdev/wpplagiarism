...
use AwesomeCoder\Contracts\Http\Kernel as HttpKernel;
use AwesomeCoder\Cookie\CookieValuePrefix;
use AwesomeCoder\Http\Request;
use AwesomeCoder\Testing\LoggedExceptionCollection;
use AwesomeCoder\Testing\TestResponse;
...
trait MakesHttpRequests
{
     ...
     *
     * @var \AwesomeCoder\Testing\TestResponse|null
     */
     ...
     * @param  string  $uri
     * @param  array  $headers
     * @return \AwesomeCoder\Testing\TestResponse
     */
    ...
    protected function prepareCookiesForRequest()
    {
        ...
        return collect($this->defaultCookies)->map(function ($value, $key) {
            return encrypt(CookieValuePrefix::create($key, plugin('encrypter')->getKey()) . $value, false);
     ...
     * @return \AwesomeCoder\Http\Response|\AwesomeCoder\Testing\TestResponse
     */
