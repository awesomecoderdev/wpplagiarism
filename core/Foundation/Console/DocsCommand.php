...
class DocsCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Access the Wordpress Plugin documentation';
    ...
    /**
     * Fetch the documentation index from the Wordpress Plugin website.
     *
    ...
    {
        return Str::before(($this->version ?? $this->plugin->version()), '.') . '.x';
    }
