...
use Closure;
use Exception;
use AwesomeCoder\Auth\Access\AuthorizationException;
...
use AwesomeCoder\Contracts\Debug\ExceptionHandler as ExceptionHandlerContract;
...
use AwesomeCoder\Http\JsonResponse;
use AwesomeCoder\Http\RedirectResponse;
use AwesomeCoder\Http\Response;
use AwesomeCoder\Routing\Exceptions\BackedEnumCaseNotFoundException;
use AwesomeCoder\Routing\Router;
use AwesomeCoder\Session\TokenMismatchException;
use AwesomeCoder\Support\Arr;
use AwesomeCoder\Support\Facades\Auth;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \AwesomeCoder\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \AwesomeCoder\Foundation\Exceptions\ReportableHandler
     */
     ...
     *
     * @param  \AwesomeCoder\Http\Request  $request
     * @param  \AwesomeCoder\Auth\AuthenticationException  $exception
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \AwesomeCoder\Validation\ValidationException  $e
     * @param  \AwesomeCoder\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \AwesomeCoder\Http\Request  $request
     * @param  \AwesomeCoder\Validation\ValidationException  $exception
     ...
     * @param  \AwesomeCoder\Http\Request  $request
     * @param  \AwesomeCoder\Validation\ValidationException  $exception
     * @return \AwesomeCoder\Http\JsonResponse
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (!$this->isHttpException($e) && config('app.debug')) {
            return $this->toAwesomeCoderResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toAwesomeCoderResponse(
     ...
     *
     * @param  AwesomeCoder\Foundation\Exception\HttpExceptionInterface  $e
     * @return \Symfony\Component\HttpFoundation\Response
     */
    ...
    /**
     * Map the given exception into an AwesomeCoder response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \AwesomeCoder\Http\Response
     */
    protected function toAwesomeCoderResponse($response, Throwable $e)
    {
