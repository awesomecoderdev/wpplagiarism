...
use AwesomeCoder\Contracts\Cache\Factory;
use AwesomeCoder\Contracts\Cache\Repository;
use AwesomeCoder\Contracts\Foundation\MaintenanceMode;
...
class CacheBasedMaintenanceMode implements MaintenanceMode
{
     ...
     * The cache factory.
     *
     * @var \AwesomeCoder\Contracts\Cache\Factory
     */
    protected $cache;
     ...
     *
     * @param  \AwesomeCoder\Contracts\Cache\Factory  $cache
     * @param  string  $store
     * @param  string  $key
     * @return void
     */
